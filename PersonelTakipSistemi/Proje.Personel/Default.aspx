<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="Proje.Personel.Default" %>
...
<head runat="server">
    ...
    <link rel="stylesheet" href="/Tasarim/css/fonts/icomoon/style.css">

    <link rel="stylesheet" href="/Tasarim/css/bootstrap.min.css">
    <link rel="stylesheet" href="/Tasarim/css/animate.min.css">
    <link rel="stylesheet" href="/Tasarim/css/jquery.fancybox.min.css">
    <link rel="stylesheet" href="/Tasarim/css/owl.carousel.min.css">
    <link rel="stylesheet" href="/Tasarim/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="/Tasarim/css/fonts/flaticon/font/flaticon.css">
    <link rel="stylesheet" href="/Tasarim/css/aos.css">
...
<body>
    ...
    <div class="owl-carousel owl-1">
      <div class="ftco-blocks-cover-1">
        <div class="ftco-cover-1" style="background-image: url('/Tasarim/images/hero_1.jpg');">
            <div class="container">
      ...
      <div class="ftco-blocks-cover-1">
        <div class="ftco-cover-1" style="background-image: url('/Tasarim/images/hero_2.jpg');">
          <div class="container">
              <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 text-center">
      ...
      <div class="ftco-blocks-cover-1">
        <div class="ftco-cover-1" style="background-image: url('/Tasarim/images/hero_3.jpg');">
          <div class="container">
            <div class="row align-items-center justify-content-center">
              <div class="col-lg-6 text-center">
        ...
        <div class="row">
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="">
            ...
            <div class="media-92812">
              <img src="/Tasarim/images/img_1.jpg" alt="Image" class="img-fluid">
              <div class="text">
          ...
          <div class="col-md-6 ml-auto" data-aos="fade-up"  data-aos-delay="100">
            ...
            <div class="media-92812">
              <img src="/Tasarim/images/img_2.jpg" alt="Image" class="img-fluid">
              <div class="text">
          ...
          <div class="col-md-6" data-aos="fade-up" data-aos-delay="">
            ...
            <div class="media-92812">
              <img src="/Tasarim/images/img_3.jpg" alt="Image" class="img-fluid">
              <div class="text">
          ...
          <div class="col-md-6 ml-auto" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="media-92812">
              <img src="/Tasarim/images/img_4.jpg" alt="Image" class="img-fluid">
              <div class="text">
    ...
    <div class="site-section">
      ...
      <div class="media-29191">
        <div class="owl-2 owl-carousel">
          <img src="/Tasarim/images/hero_1.jpg" alt="Image" class="img-fluid">
          <img src="/Tasarim/images/hero_2.jpg" alt="Image" class="img-fluid">
          <img src="/Tasarim/images/hero_3.jpg" alt="Image" class="img-fluid">
        </div>
        <div class="container">
        ...
        <div class="row align-items-stretch">
          <div class="col-lg-3 col-md-6 mb-5">
            <div class="post-entry-1 h-100">
              <a href="#">
                <img src="/Tasarim/images/post_1.jpg" alt="Image"
                 class="img-fluid">
              </a>
          ...
          <div class="col-lg-3 col-md-6 mb-5">
            <div class="post-entry-1 h-100">
              <a href="#">
                <img src="/Tasarim/images/post_2.jpg" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
                <span class="meta">July 17, 2019</span>
          ...
          <div class="col-lg-3 col-md-6 mb-5">
            <div class="post-entry-1 h-100">
              <a href="#">
                <img src="/Tasarim/images/post_3.jpg" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
                <span class="meta">July 17, 2019</span>
          ...
          <div class="col-lg-3 col-md-6 mb-5">
            <div class="post-entry-1 h-100">
              <a href="#">
                <img src="/Tasarim/images/post_4.jpg" alt="Image"
                 class="img-fluid">
              </a>
              <div class="post-entry-1-contents">
                <span class="meta">July 17, 2019</span>
